...
The `Code` directory of this repository contains the software team's work in this project, and the `Models` directory consists of that of the hardware team. The sub-directories in these are divided based on the semester of progress. If any of the directories are incomplete, they will be updated soon. The `wiki` directory contains pretty much the same content as this file, and will be that you see on the wiki page of this project on the <a href="https://wiki.purduearc.com/">Club's Wiki</a>.
